...
void remove_boostUp(int x, int y);
void add_boostDown(int x, int y);
void remove_boostDown(int x, int y);
void add_slowSpeed(int x, int y);
void remove_slowSpeed(int x, int y);
void add_speedUp(int x, int y);
void remove_speedUp(int x, int y);
void add_addLife(int x, int y);
void remove_addLife(int x, int y);
